...
@section('title', 'Create Manufacture Order')
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header border-bottom p-1">
                <h4 class="card-title">Create Manufacture Order</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-1">
                                ...
                                <select name="dealer_id" id="dealer_id" class="form-control select2">
                                    ...
                                    <option value="{{ $dealer->id }}" data-phone="{{ $dealer->phone }}" data-address="{{ $dealer->address }}">{{ $dealer->name }} ({{ $dealer->phone }})</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" id="dealer_phone" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-1">
                                <label for="dealer_address">Dealer Address</label>
                                <input type="text" id="dealer_address" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-1">
                                <label for="manufacture_qty">Manufacture Quantity <span class="text-danger">*</span></label>
                                <input type="number" name="manufacture_qty" id="manufacture_qty" class="form-control" value="1" min="1">
                    ...
                    <div class="row mt-2" id="prices-section">
                        ...
                        <div class="col-md-6">
                            <div class="form-check custom-control custom-checkbox mb-1">
                                <input type="checkbox" class="custom-control-input part-checkbox" id="part_body" name="parts[]" value="body">
                                <label class="custom-control-label" for="part_body">Body Part (Price: <span id="display_body_price">0.00</span>)</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check custom-control custom-checkbox mb-1">
                                <input type="checkbox" class="custom-control-input part-checkbox" id="part_finishing" name="parts[]" value="finishing">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4">
                            <div class="form-group mb-1">
                                ...
                                <input type="text" id="body_total" class="form-control font-weight-bold" value="0.00" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-1">
                                <label>Finishing Total</label>
                                <input type="text" id="finishing_total" class="form-control font-weight-bold" value="0.00" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-1">
                                <label>Grand Total</label>
                                <input type="text" id="grand_total" class="form-control font-weight-bold text-success" value="0.00" readonly>
                            </div>
                        </div>
                    </div>
    ...
    $(function () {
        ...
        $('#manufactureForm').on('submit', function (e) {
            ...
            if (!$('#part_body').is(':checked') && !$('#part_finishing').is(':checked')) {
                ...
                $('#saveBtn').text('Save Order').attr('disabled', false);
                return;
            }
