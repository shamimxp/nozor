            ...
            <div class="card-body mt-2">
                <form id="manufactureForm">
                    <div class="row">
                        ...
                        <div class="col-md-4" id="prices-section">
                            <div class="form-group mb-1">
                                <label for="parts">Select Part <span class="text-danger">*</span></label>
                                <select name="parts[]" id="parts" class="form-control select2">
                                    <option value="">Select Part</option>
                                    <option value="body" id="opt_body">Body Part (Price: 0.00)</option>
                                    <option value="finishing" id="opt_finishing">Finishing Part (Price: 0.00)</option>
                                </select>
