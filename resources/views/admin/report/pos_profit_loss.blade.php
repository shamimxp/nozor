...
@section('title', 'POS Order Profit/Loss Report')
@section('content')
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <h2 class="content-header-title float-left mb-0">POS Order Profit/Loss Report</h2>
        </div>
    </div>
...
<script>
    $(function() {
        var table = $('#reportTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.report.pos-profit-loss') }}",
                data: function (d) {
        ...
        $('#exportExcel').click(function(e) {
            ...
            window.location.href = "{{ route('admin.report.export-pos-profit-loss-excel') }}?start_date=" + start + "&end_date=" + end;
        });
        ...
        $('#exportPdf').click(function(e) {
            ...
            var start = $('#start_date').val();
            var end = $('#end_date').val();
            window.location.href = "{{ route('admin.report.export-pos-profit-loss-pdf') }}?start_date=" + start + "&end_date=" + end;
        });
    });
</script>
@endpush
