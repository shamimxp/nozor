...
@section('title', 'Vendor Inventory Purchase History')
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header border-bottom p-1 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.inventory-purchase.vendor-history-pdf') }}" class="btn btn-primary btn-sm">
...
<script>
    $(function () {
        var table = $('#vendorHistoryTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.inventory-purchase.vendor-history') }}",
            columns: [
                ...
                //         return '<a href="{{ url("admin/inventory-purchase/vendor-payments") }}/' + data + '" class="btn btn-sm btn-info">View Details</a>';
                //     }
                // },
            ],
