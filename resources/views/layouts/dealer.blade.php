...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('admin/app-assets/images/logo/edited_red_letters.svg') }}">
...
<!-- BEGIN: Header-->
@include('dealer.inc.header')
<!-- END: Header-->
<!-- BEGIN: Main Menu-->
@include('dealer.inc.sidebar')
<!-- END: Main Menu-->
<!-- BEGIN: Content-->
